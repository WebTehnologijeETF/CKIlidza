<?php include 'zaglavlje.html'?>
 ...
 if(isset($_POST['username']) && isset($_POST['password'])&& isset($_POST['email']))
  { 
	...
	if($query->execute()) 
        {
           echo $poruka = "Uspješno ste se prijavili kao korisnik. Dobro nam došli :D";
		//print '<br><small><a href="#" style="float:right"  onclick=openPage("index.html")><< Nazad na početnu</a></small>';    
