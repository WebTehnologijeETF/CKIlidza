	 ...
	 print '<div class= "sadrzaj" id="tijelo">';
         foreach ($rezultat as $novosti) {
          ...
          print"<p class =naslovN>".$novosti['naslov']."<p class =autor>".$novosti['autor']."&nbsp&nbsp&nbsp".date("d.m.Y.(h:i)", $novosti['datum2'])."</p>"."<p class=slika><img src=".$novosti['slika'].">"."</p>"."<p class=tekst>".$trimstring."</p>";
